...
df2=pd.read_csv( 'split_label_exps/split5/run-FedDyn_mnist_2NN_n_cli_5_rule_split_label5_rule_arg_0.3_SGD_S100_F1.000000_Lr0.100000_1_1.000000_B50_E1_W0.001000_a0.010000_seed0_lrdecay0.998000_Loss_test_Sel clients-tag-Loss_test.csv')
df3=pd.read_csv( 'split_label_exps/split5/run-FedDC_0.1mnist_2NN_n_cli_5_rule_split_label5_rule_arg_0.3_SGD_S100_F1.000000_Lr0.100000_1_1.000000_B50_E1_W0.001000_a0.100000_seed0_lrdecay0.998000_Loss_test_Sel clients-tag-Loss_test.csv')
df4=pd.read_csv( 'split_label_exps/split5/run-FedAvg_mnist_2NN_n_cli_5_rule_split_label5_rule_arg_0.3_SGD_S100_F1.000000_Lr0.100000_1_1.000000_B50_E1_W0.001000_lrdecay0.998000_seed0_Loss_test_Sel clients-tag-Loss_test.csv')
...
sns.lineplot(df2.Value[:140], label='FedDyn',ax=axs[0], linestyle='-.', color='C0',linewidth=1.5, legend=False)
sns.lineplot(df3.Value[:140], label='FedDC',ax=axs[0], linestyle='-.', color='C1',linewidth=1.5, legend=False)
sns.lineplot(df4.Value[:140], label='FedAvg',ax=axs[0], linestyle='-.',color='C3',linewidth=1.5,  legend=False)

sns.lineplot(df1[df1['client_list']==1]['test_losses'].values[:140] ,ax=axs[0],color='C2', linestyle='-',label='Peer Model',linewidth=1.5,  legend=False)
sns.lineplot(df1[df1['client_list']==2]['test_losses'].values[:140] ,ax=axs[0],color='C2', linestyle='-',label='Peer Model',linewidth=1.5,  legend=False)
sns.lineplot(df1[df1['client_list']==3]['test_losses'].values[:140] ,ax=axs[0],color='C2', linestyle='-',label='Peer Model',linewidth=1.5,  legend=False)
sns.lineplot(df1[df1['client_list']==4]['test_losses'].values[:140] ,ax=axs[0], color='C2',linestyle='-',label='Peer Model',linewidth=1.5,  legend=False)
sns.lineplot(df1[df1['client_list']==5]['test_losses'].values[:140] ,ax=axs[0],color='C2', linestyle='-',label='Peer Model',linewidth=1.5,  legend=False)
