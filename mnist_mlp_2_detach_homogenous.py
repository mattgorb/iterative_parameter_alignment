...
def get_datasets(args):
    ...
    if args.baseline:
        ...
        random.shuffle(lst)
        train_loaders = []
        for group in np.array_split(lst, 2):
...
class Merge_Iterator:
    ...
    def results_to_csv(self):
            ...
            df.to_csv(f'/s/luffy/b/nobackup/mgorb/weight_alignment_csvs/mlp_detach_weight_diff_{self.args.align_loss}_model1_homogenous.csv')
            ...
            df.to_csv(f'/s/luffy/b/nobackup/mgorb/weight_alignment_csvs/mlp_detach_weight_diff_{self.args.align_loss}_model2_homogenous.csv')
            ...
            df.to_csv(f'/s/luffy/b/nobackup/mgorb/weight_alignment_csvs/mlp_detach_model_stats_{self.args.align_loss}_homogenous.csv')
...
def main():
    ...
    if args.baseline:
        ...
        df.to_csv(f'/s/luffy/b/nobackup/mgorb/weight_alignment_csvs/mlp_detach_model_stats_baseline_homogenous.csv')
