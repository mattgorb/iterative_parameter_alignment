...
print(df.shape)
plt.clf()
plt.plot([i for i in range(len(df['model1_fc1'].values))], df['model1_fc2'], '.-')
plt.plot([i for i in range(len(df['model2_fc1'].values))], df['model2_fc2'], '.-')
#plt.plot([i for i in range(len(df['model1_wa2'].values))], df['model1_wa2'], '.-')
plt.plot([i for i in range(len(df['model2_wa1'].values))], df['model2_wa2'], '.-')
